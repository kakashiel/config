...
function _G.get_runtime_dir()
  local lvim_runtime_dir = os.getenv "MYNVIM_RUNTIME_DIR"
...
function _G.get_config_dir()
  local lvim_config_dir = os.getenv "MYNVIM_CONFIG_DIR"
...
function _G.get_cache_dir()
  local lvim_cache_dir = os.getenv "MYNVIM_CACHE_DIR"
...
function M:init(base_dir)
  ...
  if os.getenv "MYNVIM_RUNTIME_DIR" then
